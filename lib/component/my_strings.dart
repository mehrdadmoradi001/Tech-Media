class MyStrings {
  ...
  static const String viewHotsBlog = "مشاهده داغ ترین نوشته ها ";
  static const String viewHotsPodCasts = "مشاهده داغ ترین پادکست ها";
...
""";
  ...
  static String freelance ="بخش چهارم : فریلنسر دیوانه";
  ...
  static String  hour ="ساعت";
  static String  isEmail="isEmail:";
  static String  tecEmail="techblog@gmail.com";
  static String  enterEmail= "لطفا ایمیل خود را به درستی وارد کنید";
