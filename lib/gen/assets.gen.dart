...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/writer.svg
  SvgGenImage get writer => const SvgGenImage('assets/icons/writer.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/poster_teste.jpg
  AssetGenImage get posterTeste =>
      const AssetGenImage('assets/images/poster_teste.jpg');

  /// File path: assets/images/profileAvatar.svg
  SvgGenImage get profileAvatar =>
      const SvgGenImage('assets/images/profileAvatar.svg');

  /// File path: assets/images/single_place_holder.png
  AssetGenImage get singlePlaceHolder =>
      const AssetGenImage('assets/images/single_place_holder.png');
